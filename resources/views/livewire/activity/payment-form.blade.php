<div class="space-y-4">
    ...
    <div class="bg-surface rounded-card border border-border p-6 shadow-sm space-y-4">
        <h2 class="text-xs font-bold text-ink uppercase tracking-wider">Record Payment Received for {{ $lead->name }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
            ...
            <div>
                ...
                <input type="number" wire:model="amount" step="5000" class="w-full p-2.5 rounded-lg border border-border bg-canvas text-ink mt-1">
            </div>
            ...
            <div>
                ...
                <input type="text" wire:model="transactionReference" class="w-full p-2.5 rounded-lg border border-border bg-canvas text-ink mt-1">
            </div>

            <div class="md:col-span-2">
                <label class="font-bold text-ink">Notes / Bank Name</label>
                <textarea wire:model="notes" rows="2" class="w-full p-2.5 rounded-lg border border-border bg-canvas text-ink mt-1"></textarea>
            </div>
        </div>
